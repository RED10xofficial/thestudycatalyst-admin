...
export interface ApiVideoTutorialTypeVideoTutorialType
  extends Struct.CollectionTypeSchema {
  collectionName: 'video_tutorial_types';
  info: {
    displayName: 'Video Tutorial';
    pluralName: 'video-tutorial-types';
    singularName: 'video-tutorial-type';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::video-tutorial-type.video-tutorial-type'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
